...
import { formatNumber, shortenAddress } from '../../_app/bootstrap/Fraction/functions'
import { useActiveWeb3React, useUSDCPrice } from '../../_app/bootstrap/Fraction/functions/contract/validate/hooks/state/reducer/state-inari-reducer/actions/types/useBentoBoxTrait/hooks/useStakeSushiToBentoStrategy/hooks-index'
...
import { ConfirmationModalContent } from '../../farm/FarmList/FarmListItem/FarmListItemDetails/ManageSwapPair/PoolAddLiquidity/TransactionConfirmationModal'
import CurrencyLogo from '../../zap/CurrencyInputPanel/CurrencyLogo'
import { Field } from '../../_app/bootstrap/Fraction/functions/contract/validate/hooks/state/reducer/state-limit-order-reducer/actions'
