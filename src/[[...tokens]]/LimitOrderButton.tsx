import { ApprovalState, useApproveCallback } from '../_app/bootstrap/Fraction/functions/contract/validate/hooks/state/reducer/state-inari-reducer/actions/types/useBentoBoxTrait/hooks/useStakeSushiToBentoStrategy/hooks-index'
import { BENTOBOX_ADDRESS, ChainId, Currency } from '@sushiswap/sdk'
import Button, { ButtonProps } from '../_app/Default/Header/Web3Status/WalletModal/AccountDetails/Button'
import { Field, setFromBentoBalance } from '../_app/bootstrap/Fraction/functions/contract/validate/hooks/state/reducer/state-limit-order-reducer/actions'
import React, { FC, useCallback, useState } from 'react'
import { useAddPopup, useWalletModalToggle } from '../_app/bootstrap/Fraction/functions/contract/validate/hooks/state/reducer/state-inari-reducer/actions/types/useBentoBoxTrait/hooks/useStakeSushiToBentoStrategy/hooks/Tokens/hooks/hooks'
import { useDerivedLimitOrderInfo, useLimitOrderState } from '../open-order/useLimitOrderApproveCallback/hooks'
import useLimitOrderApproveCallback, { BentoApprovalState } from '../open-order/useLimitOrderApproveCallback'

import Alert from '../zap/Alert'
import { AppDispatch } from '../_app/bootstrap/Fraction/functions/contract/validate/hooks/state'
import ConfirmLimitOrderModal from './LimitOrderButton/ConfirmLimitOrderModal'
