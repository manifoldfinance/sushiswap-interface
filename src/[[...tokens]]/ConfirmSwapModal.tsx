...
} from '../farm/FarmList/FarmListItem/FarmListItemDetails/ManageSwapPair/PoolAddLiquidity/TransactionConfirmationModal'
import SwapModalFooter from './ConfirmSwapModal/SwapModalFooter'
import SwapModalHeader from './ConfirmSwapModal/SwapModalHeader'
