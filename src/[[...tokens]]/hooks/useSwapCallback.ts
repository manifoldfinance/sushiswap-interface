import { BIPS_BASE, EIP_1559_ACTIVATION_BLOCK } from '../../_app/bootstrap/Fraction/functions/contract/validate/hooks/state/reducer/state-user-reducer/constants'
import {
  ChainId,
  Currency,
  CurrencyAmount,
...
import { isAddress, isZero } from '../../_app/bootstrap/Fraction/functions/contract/validate'
import { arrayify, hexlify, splitSignature } from '@ethersproject/bytes'
import { useFactoryContract, useRouterContract } from '../../_app/bootstrap/Fraction/functions/contract/validate/hooks/state/reducer/state-inari-reducer/actions/types/useBentoBoxTrait/hooks/useStakeSushiToBentoStrategy/hooks/useContract'
import { ARCHER_RELAY_URI } from '../archer'
import { OPENMEV_URI } from '../openmev'
import { ArcherRouter } from './useSwapCallback/archerRouter'
import { BigNumber } from '@ethersproject/bignumber'
import Common from '@ethereumjs/common'
import { SignatureData } from '../../_app/bootstrap/Fraction/functions/contract/validate/hooks/state/reducer/state-inari-reducer/actions/types/useHasPermitTokenTrait/useERC20Permit'
import { TransactionFactory } from '@ethereumjs/tx'
import { TransactionRequest } from '@ethersproject/abstract-provider'
import { keccak256 } from '@ethersproject/keccak256'
import approveAmountCalldata from './useSwapCallback/approveAmountCalldata'
import { calculateGasMargin } from '../../_app/bootstrap/Fraction/functions/contract/validate/hooks/state/reducer/state-inari-reducer/actions/types/useBentoBoxTrait/hooks/useStakeSushiToBentoStrategy/hooks-index/useApproveCallback/trade'
...
import { useArgentWalletContract } from './useSwapCallback/useArgentWalletContract'
import { useBlockNumber } from '../../_app/bootstrap/Fraction/functions/contract/validate/hooks/state/reducer/state-inari-reducer/actions/types/useBentoBoxTrait/hooks/useStakeSushiToBentoStrategy/hooks/Tokens/hooks/hooks'
import useENS from '../../open-order/useLimitOrderApproveCallback/hooks/useENS'
...
import { useUserArcherETHTip } from '../../_app/bootstrap/Fraction/functions/contract/validate/hooks/state/reducer/state-inari-reducer/actions/types/useBentoBoxTrait/hooks/useStakeSushiToBentoStrategy/hooks/Tokens/hooks'
