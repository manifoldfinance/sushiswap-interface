import { ZERO, calculateGasMargin } from '../_app/bootstrap/Fraction/functions'
import { getSignatureWithProviderBentobox, getVerifyingContract } from 'limitorderv2-sdk'
import { setFromBentoBalance, setLimitOrderApprovalPending } from '../_app/bootstrap/Fraction/functions/contract/validate/hooks/state/reducer/state-limit-order-reducer/actions'
import { useBentoBoxContract, useLimitOrderHelperContract } from '../_app/bootstrap/Fraction/functions/contract/validate/hooks/state/reducer/state-inari-reducer/actions/types/useBentoBoxTrait/hooks/useStakeSushiToBentoStrategy/hooks/useContract'
import { useCallback, useEffect, useMemo, useState } from 'react'
import { useDerivedLimitOrderInfo, useLimitOrderApprovalPending, useLimitOrderState } from './useLimitOrderApproveCallback/hooks'
...
import { useBentoMasterContractAllowed } from '../_app/bootstrap/Fraction/functions/contract/validate/hooks/state/reducer/state-inari-reducer/actions/types/useBentoBoxTrait/hooks/useStakeSushiToBentoStrategy/hooks'
