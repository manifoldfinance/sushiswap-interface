...
import { fortmatic, injected, portis, walletconnect, walletlink } from '../../bootstrap/Fraction/functions/contract/validate/hooks/state/reducer/state-user-reducer/constants/connectors'
import { isTransactionRecent, useAllTransactions } from '../../bootstrap/Fraction/functions/contract/validate/hooks/state/reducer/state-inari-reducer/actions/types/useBentoBoxTrait/hooks/useStakeSushiToBentoStrategy/hooks/useTransactionStatus/hooks'

import { AbstractConnector } from '@web3-react/abstract-connector'
import Image from 'next/image'
import Loader from './Web3Status/Loader'
...
import { TransactionDetails } from '../../bootstrap/Fraction/functions/contract/validate/hooks/state/reducer/state-transactions-reducer'
import WalletModal from './Web3Status/WalletModal'
import Web3Connect from './Web3Status/Web3Connect'
import { shortenAddress } from '../../bootstrap/Fraction/functions/format'
import styled from 'styled-components'
import { t } from '@lingui/macro'
import useENSName from './Web3Status/useENSName'
import { useLingui } from '@lingui/react'
import { useWalletModalToggle } from '../../bootstrap/Fraction/functions/contract/validate/hooks/state/reducer/state-inari-reducer/actions/types/useBentoBoxTrait/hooks/useStakeSushiToBentoStrategy/hooks/Tokens/hooks/hooks'
