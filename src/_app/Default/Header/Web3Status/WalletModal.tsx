...
import { fortmatic, injected, portis } from '../../../bootstrap/Fraction/functions/contract/validate/hooks/state/reducer/state-user-reducer/constants/connectors'
import { useModalOpen, useWalletModalToggle } from '../../../bootstrap/Fraction/functions/contract/validate/hooks/state/reducer/state-inari-reducer/actions/types/useBentoBoxTrait/hooks/useStakeSushiToBentoStrategy/hooks/Tokens/hooks/hooks'

import { AbstractConnector } from '@web3-react/abstract-connector'
import AccountDetails from './WalletModal/AccountDetails'
import { ApplicationModal } from '../../../bootstrap/Fraction/functions/contract/validate/hooks/state/reducer/reducer/actions'
import { ButtonError } from './WalletModal/AccountDetails/Button'
import ExternalLink from '../../Footer/ExternalLink'
import Image from 'next/image'
import Modal from '../Web3Network/NetworkModal/Modal'
import ModalHeader from '../Web3Network/NetworkModal/ModalHeader'
import { OVERLAY_READY } from '../../../bootstrap/Fraction/functions/contract/validate/hooks/state/reducer/state-user-reducer/constants/connectors/Fortmatic'
import Option from './WalletModal/Option'
import PendingView from './WalletModal/PendingView'
import ReactGA from 'react-ga'
import { SUPPORTED_WALLETS } from '../../../bootstrap/Fraction/functions/contract/validate/hooks/state/reducer/state-user-reducer/constants'
...
import usePrevious from './WalletModal/usePrevious'
