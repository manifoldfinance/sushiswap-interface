import { Call, parseCallKey } from './bootstrap/Fraction/functions/contract/validate/hooks/state/reducer/state-multicall-reducer/actions/utils'
import { RetryableError, retry } from './bootstrap/Fraction/functions/retry'
import { errorFetchingMulticallResults, fetchingMulticallResults, updateMulticallResults } from './bootstrap/Fraction/functions/contract/validate/hooks/state/reducer/state-multicall-reducer/actions'
import { useAppDispatch, useAppSelector } from './bootstrap/Fraction/functions/contract/validate/hooks/state/reducer/state-inari-reducer/actions/types/useBentoBoxTrait/hooks/hooks'
import { useEffect, useMemo, useRef } from 'react'

import { AppState } from './bootstrap/Fraction/functions/contract/validate/hooks/state'
import { Contract } from 'ethers'
import { chunkArray } from './bootstrap/Fraction/functions/array'
import { updateBlockNumber } from './bootstrap/Fraction/functions/contract/validate/hooks/state/reducer/reducer/actions'
...
import { useBlockNumber } from './bootstrap/Fraction/functions/contract/validate/hooks/state/reducer/state-inari-reducer/actions/types/useBentoBoxTrait/hooks/useStakeSushiToBentoStrategy/hooks/Tokens/hooks/hooks'
import useDebounce from './updater/useDebounce'
import { useMulticall2Contract } from './bootstrap/Fraction/functions/contract/validate/hooks/state/reducer/state-inari-reducer/actions/types/useBentoBoxTrait/hooks/useStakeSushiToBentoStrategy/hooks/useContract'
