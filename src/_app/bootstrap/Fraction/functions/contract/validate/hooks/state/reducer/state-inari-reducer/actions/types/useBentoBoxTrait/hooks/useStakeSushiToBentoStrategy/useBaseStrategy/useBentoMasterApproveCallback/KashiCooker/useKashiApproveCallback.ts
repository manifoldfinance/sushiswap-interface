import KashiCooker, { signMasterContractApproval } from '../KashiCooker'
import { useCallback, useEffect, useMemo, useState } from 'react'

import { KASHI_ADDRESS } from '@sushiswap/sdk'
import { ethers } from 'ethers'
import { setKashiApprovalPending } from '../../../../../../../../../reducer/actions'
import { useActiveWeb3React } from '../../../hooks/useContract/useActiveWeb3React'
import { useBentoBoxContract } from '../../../hooks/useContract'
import { useBentoMasterContractAllowed } from '../../../hooks'
import { useDispatch } from 'react-redux'
import { useKashiApprovalPending } from '../../../hooks/Tokens/hooks/hooks'
import { useTransactionAdder } from '../../../hooks/useTransactionStatus/hooks'
