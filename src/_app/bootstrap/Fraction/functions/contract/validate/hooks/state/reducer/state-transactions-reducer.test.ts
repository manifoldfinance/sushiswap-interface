...
import { addTransaction, checkedTransaction, clearAllTransactions, finalizeTransaction } from './state-transactions-reducer/actions'
import reducer, { initialState, TransactionState } from './state-transactions-reducer'
