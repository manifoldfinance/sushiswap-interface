...
} from './useContract/argent-wallet-detector.json'

import ALCX_REWARDER_ABI from './useContract/alcx-rewarder.json'
import ARCHER_ROUTER_ABI from '../../../../../../../../../../../archer-router.json'
import { AddressZero } from '@ethersproject/constants'
import BAR_ABI from './useContract/bar.json'
import BASE_SWAPPER_ABI from './useContract/swapper.json'
import BENTOBOX_ABI from './useContract/bentobox.json'
import BORING_HELPER_ABI from './useContract/boring-helper.json'
import CHAINLINK_ORACLE_ABI from './useContract/chainlink-oracle.json'
import CLONE_REWARDER_ABI from './useContract/clone-rewarder.json'
import COMPLEX_REWARDER_ABI from './useContract/complex-rewarder.json'
import { Contract } from '@ethersproject/contracts'
import DASHBOARD_ABI from './useContract/dashboard.json'
import EIP_2612_ABI from './useContract/eip-2612.json'
import ENS_ABI from './useContract/ens-registrar.json'
import ENS_PUBLIC_RESOLVER_ABI from './useContract/ens-public-resolver.json'
import ERC20_ABI from './useContract/erc20.json'
import { ERC20_BYTES32_ABI } from './useContract/erc20.json'
import FACTORY_ABI from './useContract/factory.json'
import INARI_ABI from './useContract/inari.json'
import IUniswapV2PairABI from './useContract/uniswap-v2-pair.json'
import KASHIPAIR_ABI from './useContract/kashipair.json'
import LIMIT_ORDER_ABI from './useContract/limit-order.json'
import LIMIT_ORDER_HELPER_ABI from './useContract/limit-order-helper.json'
import MAKER_ABI from './useContract/maker.json'
import MASTERCHEF_ABI from './useContract/masterchef.json'
import MASTERCHEF_V2_ABI from './useContract/masterchef-v2.json'
import MEOWSHI_ABI from './useContract/meowshi.json'
import MERKLE_DISTRIBUTOR_ABI from './useContract/merkle-distributor.json'
import MINICHEF_ABI from './useContract/minichef-v2.json'
import MULTICALL2_ABI from './useContract/multicall2.json'
import PENDING_ABI from './useContract/pending.json'
import ROUTER_ABI from './useContract/router.json'
import SAAVE_ABI from './useContract/saave.json'
import SUSHIROLL_ABI from '@sushiswap/core/abi/SushiRoll.json'
import SUSHISWAP_TWAP_ORACLE_ABI from './useContract/sushiswap-slp-oracle.json'
import SUSHI_ABI from './useContract/sushi.json'
import TIMELOCK_ABI from './useContract/timelock.json'
import UNI_FACTORY_ABI from './useContract/uniswap-v2-factory.json'
import WETH9_ABI from './useContract/weth.json'
import ZAPPER_ABI from './useContract/zapper.json'
import ZENKO_ABI from './useContract/zenko.json'
import { getContract } from '../../../../../../../../../../../../contract'
import { getVerifyingContract } from 'limitorderv2-sdk'
import { useActiveWeb3React } from './useContract/useActiveWeb3React'
