import { useDerivedInariState } from './useBentoBoxTrait/hooks'
import useBentoMasterApproveCallback, { BentoMasterApproveCallback } from './useBentoBoxTrait/hooks/useStakeSushiToBentoStrategy/useBaseStrategy/useBentoMasterApproveCallback'
import { ApprovalState, useActiveWeb3React, useInariContract } from './useBentoBoxTrait/hooks/useStakeSushiToBentoStrategy/hooks-index'
import { useCallback } from 'react'
import { CurrencyAmount, Token } from '@sushiswap/sdk'
import { useTransactionAdder } from './useBentoBoxTrait/hooks/useStakeSushiToBentoStrategy/hooks/useTransactionStatus/hooks'
import useTrait, { BaseTrait } from './useBentoBoxTrait/useTrait'
import { BaseStrategyHook } from './useBentoBoxTrait/hooks/useStakeSushiToBentoStrategy/useBaseStrategy'
