...
import ArcherSwapRouterABI from './contract/archer-router.json'
import { Contract } from '@ethersproject/contracts'
import IUniswapV2Router02ABI from './contract/uniswap-v2-router-02.json'
import IUniswapV2Router02NoETHABI from './contract/uniswap-v2-router-02-no-eth.json'
import { isAddress } from './contract/validate'
