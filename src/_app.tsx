...
import store, { persistor } from './_app/bootstrap/Fraction/functions/contract/validate/hooks/state'

import type { AppProps } from 'next/app'
import ApplicationUpdater from './_app/updater'
import DefaultLayout from './_app/Default'
import Dots from './_app/Default/Header/Web3Status/WalletModal/PendingView/Dots'
import Head from 'next/head'
import { I18nProvider } from '@lingui/react'
import ListsUpdater from './_app/state-lists-updater'
import MulticallUpdater from './_app/updater'
import { PersistGate } from 'redux-persist/integration/react'
import ReactGA from 'react-ga'
import { Provider as ReduxProvider } from 'react-redux'
import TransactionUpdater from './_app/state-transactions-updater'
import UserUpdater from './_app/state-user-updater'
import Web3ReactManager from './_app/Web3ReactManager'
import { Web3ReactProvider } from '@web3-react/core'
import dynamic from 'next/dynamic'
import getLibrary from './_app/getLibrary'
...
const Web3ProviderNetwork = dynamic(() => import('./_app/Web3ProviderNetwork'), { ssr: false })
