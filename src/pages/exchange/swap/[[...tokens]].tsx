import { INITIAL_ALLOWED_SLIPPAGE } from '../../../_app/bootstrap/Fraction/functions/contract/validate/hooks/state/reducer/state-user-reducer/constants'
import {
...
import { ARCHER_RELAY_URI } from '../../../[[...tokens]]/archer'
import { OPENMEV_RELAY_URI } from '../../../[[...tokens]]/openmev'

import { ApprovalState, useApproveCallbackFromTrade } from '../../../_app/bootstrap/Fraction/functions/contract/validate/hooks/state/reducer/state-inari-reducer/actions/types/useBentoBoxTrait/hooks/useStakeSushiToBentoStrategy/hooks-index/useApproveCallback'
import { ArrowWrapper, BottomGrouping, SwapCallbackError } from '../../../[[...tokens]]/styleds'
import { AutoRow, RowBetween, RowFixed } from '../../../_app/Default/Popups/PopupItem/TransactionPopup/Row'
import { ButtonConfirmed, ButtonError } from '../../../_app/Default/Header/Web3Status/WalletModal/AccountDetails/Button'
import Column, { AutoColumn } from '../../../zap/Column'
import React, { useCallback, useEffect, useMemo, useState } from 'react'
import { UseERC20PermitState, useERC20PermitFromTrade } from '../../../_app/bootstrap/Fraction/functions/contract/validate/hooks/state/reducer/state-inari-reducer/actions/types/useHasPermitTokenTrait/useERC20Permit'
import { useAllTokens, useCurrency } from '../../../_app/bootstrap/Fraction/functions/contract/validate/hooks/state/reducer/state-inari-reducer/actions/types/useBentoBoxTrait/hooks/useStakeSushiToBentoStrategy/hooks/Tokens'
import {
...
import { useNetworkModalToggle, useToggleSettingsMenu, useWalletModalToggle } from '../../../_app/bootstrap/Fraction/functions/contract/validate/hooks/state/reducer/state-inari-reducer/actions/types/useBentoBoxTrait/hooks/useStakeSushiToBentoStrategy/hooks/Tokens/hooks/hooks'
import useWrapCallback, { WrapType } from '../../../[[...tokens]]/useWrapCallback'

import AddressInputPanel from '../../../[[...tokens]]/AddressInputPanel'
import { AdvancedSwapDetails } from '../../../[[...tokens]]/AdvancedSwapDetails'
import AdvancedSwapDetailsDropdown from '../../../[[...tokens]]/AdvancedSwapDetailsDropdown'
import Alert from '../../../zap/Alert'
import { ArrowDownIcon } from '@heroicons/react/outline'
import Button from '../../../_app/Default/Header/Web3Status/WalletModal/AccountDetails/Button'
import ConfirmSwapModal from '../../../[[...tokens]]/ConfirmSwapModal'
import Container from '../../Container'
import CurrencyInputPanel from '../../../zap/CurrencyInputPanel'
import DoubleGlowShadow from '../../../zap/DoubleGlowShadow'
...
import Loader from '../../../_app/Default/Header/Web3Status/Loader'
import Lottie from 'lottie-react'
import MinerTip from '../../../[[...tokens]]/MinerTip'
import ProgressSteps from '../../../zap/ProgressSteps'
import ReactGA from 'react-ga'
import SwapHeader from '../../../[[...tokens]]/ExchangeHeader'
import TokenWarningModal from '../../../[[...tokens]]/TokenWarningModal'
import TradePrice from '../../../[[...tokens]]/ConfirmSwapModal/SwapModalHeader/TradePrice'
import Typography from '../../../_app/Default/Header/Web3Network/NetworkModal/ModalHeader/Typography'
import UnsupportedCurrencyFooter from '../../../[[...tokens]]/UnsupportedCurrencyFooter'
import Web3Connect from '../../../_app/Default/Header/Web3Status/Web3Connect'
import { computeFiatValuePriceImpact } from '../../../_app/bootstrap/Fraction/functions/contract/validate/hooks/state/reducer/state-inari-reducer/actions/types/useBentoBoxTrait/hooks/useStakeSushiToBentoStrategy/hooks-index/useApproveCallback/trade'
import confirmPriceImpactWithoutFee from '../../../[[...tokens]]/confirmPriceImpactWithoutFee'
import { maxAmountSpend } from '../../../_app/bootstrap/Fraction/functions/currency'
import swapArrowsAnimationData from '../../../[[...tokens]]/swap-arrows.json'
...
import useENSAddress from '../../../open-order/useLimitOrderApproveCallback/hooks/useENS/useENSAddress'
...
import { useIsSwapUnsupported } from '../../../[[...tokens]]/useIsSwapUnsupported'
import { useLingui } from '@lingui/react'
import usePrevious from '../../../_app/Default/Header/Web3Status/WalletModal/usePrevious'
import { useRouter } from 'next/router'
import { useSwapCallback } from '../../../[[...tokens]]/hooks/useSwapCallback'
...
import { warningSeverity } from '../../../_app/bootstrap/Fraction/functions/prices'
