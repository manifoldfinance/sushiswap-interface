import { ApprovalState, useApproveCallback } from '../../../_app/bootstrap/Fraction/functions/contract/validate/hooks/state/reducer/state-inari-reducer/actions/types/useBentoBoxTrait/hooks/useStakeSushiToBentoStrategy/hooks-index/useApproveCallback'
...
import { ONE_BIPS, ZERO_PERCENT } from '../../../_app/bootstrap/Fraction/functions/contract/validate/hooks/state/reducer/state-user-reducer/constants'
...
import { calculateGasMargin, calculateSlippageAmount } from '../../../_app/bootstrap/Fraction/functions/contract/validate/hooks/state/reducer/state-inari-reducer/actions/types/useBentoBoxTrait/hooks/useStakeSushiToBentoStrategy/hooks-index/useApproveCallback/trade'
import { currencyId, maxAmountSpend } from '../../../_app/bootstrap/Fraction/functions/currency'
import { useDerivedMintInfo, useMintActionHandlers, useMintState } from '../../../farm/FarmList/FarmListItem/FarmListItemDetails/ManageSwapPair/PoolAddLiquidity/hooks'
import { useExpertModeManager, useUserSlippageToleranceWithDefault } from '../../../_app/bootstrap/Fraction/functions/contract/validate/hooks/state/reducer/state-inari-reducer/actions/types/useBentoBoxTrait/hooks/useStakeSushiToBentoStrategy/hooks/Tokens/hooks'

import { AddRemoveTabs } from '../../../[[...tokens]]/NavigationTabs'
import Alert from '../../../zap/Alert'
import { AutoColumn } from '../../../zap/Column'
import { BigNumber } from '@ethersproject/bignumber'
import { ConfirmAddModalBottom } from '../../../farm/FarmList/FarmListItem/FarmListItemDetails/ManageSwapPair/PoolAddLiquidity/ConfirmAddModalBottom'
...
import DoubleCurrencyLogo from '../../../zap/CurrencyInputPanel/DoubleLogo'
import DoubleGlowShadow from '../../../zap/DoubleGlowShadow'
import ExchangeHeader from '../../../[[...tokens]]/ExchangeHeader'
import { Field } from '../../../_app/bootstrap/Fraction/functions/contract/validate/hooks/state/reducer/state-mint-reducer/actions'
import Head from 'next/head'
import LiquidityHeader from '../../../liquidity/LiquidityHeader'
import LiquidityPrice from '../../../liquidity/LiquidityPrice'
import { MinimalPositionCard } from '../../../find/PositionCard'
import NavLink from '../../../_app/Default/Header/More/NavLink'
import { PairState } from '../../../_app/bootstrap/Fraction/functions/contract/validate/hooks/state/reducer/state-inari-reducer/actions/types/useBentoBoxTrait/hooks/useStakeSushiToBentoStrategy/hooks-index/useUSDCPrice/useV2Trades/useV2Pairs'
...
import { useRouterContract } from '../../../_app/bootstrap/Fraction/functions/contract/validate/hooks/state/reducer/state-inari-reducer/actions/types/useBentoBoxTrait/hooks/useStakeSushiToBentoStrategy/hooks-index'
...
import useTransactionDeadline from '../../../_app/bootstrap/Fraction/functions/contract/validate/hooks/state/reducer/state-inari-reducer/actions/types/useHasPermitTokenTrait/useERC20Permit/useTransactionDeadline'
import { useWalletModalToggle } from '../../../_app/bootstrap/Fraction/functions/contract/validate/hooks/state/reducer/state-inari-reducer/actions/types/useBentoBoxTrait/hooks/useStakeSushiToBentoStrategy/hooks/Tokens/hooks/hooks'
