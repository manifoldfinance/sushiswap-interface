import { Borrow, Repay } from './[pair]/lending'
import Provider, { useKashiInfo, useKashiPair } from './farm/FarmList/FarmListItem/FarmListItemDetails/ManageKashiPair/context'
import React, { useCallback, useState } from 'react'
import { Tab, TabList, TabPanel, Tabs } from 'react-tabs'
import { formatNumber, formatPercent } from './_app/bootstrap/Fraction/functions/format'

import { BorrowCardHeader } from './zap/PoolList/CardHeader'
...
import GradientDot from './borrow/GradientDot'
...
import { useToken } from './_app/bootstrap/Fraction/functions/contract/validate/hooks/state/reducer/state-inari-reducer/actions/types/useBentoBoxTrait/hooks/useStakeSushiToBentoStrategy/hooks/Tokens'
...
import { useUSDCPrice } from './_app/bootstrap/Fraction/functions/contract/validate/hooks/state/reducer/state-inari-reducer/actions/types/useBentoBoxTrait/hooks/useStakeSushiToBentoStrategy/hooks-index'
import { useV2Pair } from './_app/bootstrap/Fraction/functions/contract/validate/hooks/state/reducer/state-inari-reducer/actions/types/useBentoBoxTrait/hooks/useStakeSushiToBentoStrategy/hooks-index/useUSDCPrice/useV2Trades/useV2Pairs'
